  ...
  return (
    <main className="container">
      ...
      <div className="grid">
        ...
        <Link href="/quran" className="card"><div className="num">Read</div><div className="en">Quran &amp; Tafsir</div><div className="meta">114 surahs · Saheeh International · Ibn Kathir</div></Link>
